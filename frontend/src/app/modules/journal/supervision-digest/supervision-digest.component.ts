...
@Component({
  ...
  styles: [`
    ...
    .page-header {
      ...
      h1 { font-size: 22px; color: var(--artes-primary); display: flex; align-items: center; gap: 8px; margin: 0 0 4px;
    ...
    .generate-prompt {
      ...
      > mat-icon { font-size: 36px; width: 36px; height: 36px; color: #7c5cbf; display: block; margin: 0 auto 12px; }
