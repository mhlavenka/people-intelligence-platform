...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, MatDialogModule, MatFormFieldModule, MatInputModule, MatButtonModule, MatIconModule, TranslateModule, DialogCloseButtonComponent],
  template: `
...
export class PasskeyLabelDialogComponent {
  label = 'Passkey';
  constructor(public dialogRef: MatDialogRef<PasskeyLabelDialogComponent>) {}
