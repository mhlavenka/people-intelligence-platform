...
const MODULE_SLIDES: ModuleSlide[] = [
  ...
  {
    icon: 'assignment',
    title: 'AUTH.slides.assessment.title',
    subtitle: 'AUTH.slides.assessment.subtitle',
    color: '#f0a500',
    heroImage: 'assets/module_intake.png',
    paragraphs: [
      'AUTH.slides.assessment.p1',
      'AUTH.slides.assessment.p2',
      'AUTH.slides.assessment.p3',
    ],
    workflow: [
      { icon: 'edit_note', label: 'AUTH.slides.assessment.wf1Label', desc: 'AUTH.slides.assessment.wf1Desc' },
      { icon: 'send', label: 'AUTH.slides.assessment.wf2Label', desc: 'AUTH.slides.assessment.wf2Desc' },
      { icon: 'analytics', label: 'AUTH.slides.assessment.wf3Label', desc: 'AUTH.slides.assessment.wf3Desc' },
      { icon: 'hub', label: 'AUTH.slides.assessment.wf4Label', desc: 'AUTH.slides.assessment.wf4Desc' },
    ],
    features: ['AUTH.slides.assessment.f1', 'AUTH.slides.assessment.f2', 'AUTH.slides.assessment.f3', 'AUTH.slides.assessment.f4', 'AUTH.slides.assessment.f5', 'AUTH.slides.assessment.f6', 'AUTH.slides.assessment.f7', 'AUTH.slides.assessment.f8'],
    stats: [{ value: '3', label: 'AUTH.slides.assessment.s1' }, { value: '5+', label: 'AUTH.slides.assessment.s2' }, { value: '6', label: 'AUTH.slides.assessment.s3' }],
  },
];
    ...
    <div class="auth-page">
      ...
      <div class="auth-card">
        <div class="lang-switcher">
          <button class="lang-btn" [class.active]="translate.currentLang === 'en'" (click)="switchLang('en')" title="English"><img src="assets/flags/gb.svg" alt="English" class="lang-flag" /></button>
          <button class="lang-btn" [class.active]="translate.currentLang === 'fr'" (click)="switchLang('fr')" title="Français"><img src="assets/flags/fr.svg" alt="Français" class="lang-flag" /></button>
          <button class="lang-btn" [class.active]="translate.currentLang === 'es'" (click)="switchLang('es')" title="Español"><img src="assets/flags/es.svg" alt="Español" class="lang-flag" /></button>
          <button class="lang-btn" [class.active]="translate.currentLang === 'sk'" (click)="switchLang('sk')" title="Slovenčina"><img src="assets/flags/sk.svg" alt="Slovenčina" class="lang-flag" /></button>
        </div>
        @if (!twoFactorStep()) {
