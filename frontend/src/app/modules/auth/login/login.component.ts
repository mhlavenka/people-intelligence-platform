    ...
    <div class="auth-page">
      ...
      <div class="auth-card">
        <div class="lang-switcher">
          ...
          <button class="lang-btn" [class.active]="translate.currentLang === 'sk'" (click)="switchLang('sk')" title="Slovenčina"><svg width="20" height="14" viewBox="0 0 20 14"><rect width="20" height="4.67" fill="#fff"/><rect y="4.67" width="20" height="4.67" fill="#0B4EA2"/><rect y="9.33" width="20" height="4.67" fill="#EE1C25"/></svg></button>
        </div>
        @if (!twoFactorStep()) {
